...
TOMATO_SHORT_LIST = ["Artwork/susa_tomata_short_1.png", "Artwork/susa_tomata_short_2.png"]
reps = 0
check_num = ""
timer = None
reset = False
...
start_button = Button(image=tomato_start, activebackground=YELLOW, borderwidth=0, bg=YELLOW, font=(FONT_NAME, 10, "bold"),
                      command=start_all)
